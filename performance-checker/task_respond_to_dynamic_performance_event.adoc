...
. Nella parte superiore della pagina, puntare il cursore sull'icona dell'evento di modifica (image:../media/opm_change_icon.gif["Icona di modifica dell'evento"]) per la modifica del limite del gruppo di criteri.
