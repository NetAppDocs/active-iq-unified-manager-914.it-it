...
+
Si consiglia di copiare il file di backup nella directory predefinita /`data/ocum`-backup. I file del repository del database devono essere copiati nella /`database-dumps-repo`sottodirectory nella /`ocum-backup`directory.
