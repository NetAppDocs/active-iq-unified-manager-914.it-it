...
. Creare un nuovo foglio (image:../media/excel_new_sheet_icon.png[""]) dopo il `data` foglio e denominarlo *capacità dati totali*.
...
. Fare clic con il pulsante destro del mouse sul grafico e selezionare *Sposta grafico* per spostare il grafico nel `Total Data Capacity` foglio.
