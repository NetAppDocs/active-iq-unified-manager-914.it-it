...
Nascondere un oggetto selezionato
 a| 
Fare clic sull'icona occhio dell'oggetto selezionato (image:../media/eye_icon.gif[""]) nel riquadro confronto. I dati dell'oggetto vengono nascosti e l'icona dell'occhio per l'oggetto diventa grigia.
