...
[role="lead"]
Le `events` API , `alerts` e `scripts` della `management-server` categoria consentono di gestire gli eventi, gli avvisi e gli script associati agli avvisi nell'ambiente Active IQ Unified Manager.
