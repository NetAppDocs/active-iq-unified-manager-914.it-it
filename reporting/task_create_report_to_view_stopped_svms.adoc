...
. Salvare la vista con un nome specifico che rifletta ciò che la vista mostra, ad esempio "`SVM interrotte'" e fare clic sul segno di spunta (image:../media/blue_check.gif[""]).
