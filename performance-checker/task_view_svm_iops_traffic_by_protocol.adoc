...
+
Viene visualizzato il grafico comparativo del protocollo avanzato IOPS. È possibile limitare il confronto deselezionando o selezionando il image:../media/eye_icon.gif["icona occhio"]associato a un protocollo.
