...
[NOTE]
====
Il "pacchetto WFA per la gestione di Clustered Data ONTAP" è incluso in WFA 5.1, quindi non è necessario scaricare questo pacchetto dal NetAppStorage Automation Store e installarlo separatamente sul server WFA come richiesto in passato. https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["Download WFA"^]
