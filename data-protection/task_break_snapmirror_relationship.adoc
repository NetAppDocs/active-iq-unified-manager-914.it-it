...
+
La colonna Stato relazione è nascosta per impostazione predefinita, pertanto potrebbe essere necessario selezionarla nell'elenco Mostra/Nascondi colonna image:../media/icon_columnshowhide_sm_onc.gif[""].
