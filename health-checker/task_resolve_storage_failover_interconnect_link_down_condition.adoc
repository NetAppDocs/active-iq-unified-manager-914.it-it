...
. Nella parte superiore della colonna *Event Management* Inventory page *Name*, fare clic su image:../media/filtericon_um60.png["Icona per il filtro di colonna"] e immettere `*failover` nella casella di testo per limitare la visualizzazione dell'evento agli eventi relativi al failover dello storage.
+
