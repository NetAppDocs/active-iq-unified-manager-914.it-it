...
== Visualizzazione della replica per configurazioni MetroCluster su IP
...
Per informazioni, vedi link:../storage-mgmt/task_monitor_metrocluster_configurations.html#monitor-connectivity-issues-in-metrocluster-over-ip-configuration["Monitorare i problemi di connettività in MetroCluster over IP"].
