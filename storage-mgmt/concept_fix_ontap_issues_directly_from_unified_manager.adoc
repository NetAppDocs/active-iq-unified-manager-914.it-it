...
Per informazioni sui problemi e le funzioni di ONTAP che è possibile gestire utilizzando la correzione automatica, vedere link:../storage-mgmt/reference_what_ontap_issues_can_unified_manager_fix.html["Quali problemi possono risolvere Unified Manager"].
