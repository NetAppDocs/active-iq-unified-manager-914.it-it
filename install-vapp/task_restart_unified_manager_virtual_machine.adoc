...
È inoltre possibile riavviare la macchina virtuale da vSphere utilizzando l'opzione VMware *Restart Guest*. Fare riferimento a https://developer.broadcom.com/powercli/latest/vmware.vimautomation.core/commands/restart-vmguest/["Restart-VMGuest cmdlet nella documentazione di riferimento dei cmdlet di VMware vSphere PowerCLI di Broadcom."^]
