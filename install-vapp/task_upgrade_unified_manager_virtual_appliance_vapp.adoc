...
[role="lead"]
È possibile aggiornare l'appliance virtuale Active IQ Unified Manager dalle versioni 9,12 o 9,13 alla 9,14.
...
. Selezionare il `ActiveIQUnifiedManager-<version>-virtual-update.iso` file e fare clic su *Apri*.
