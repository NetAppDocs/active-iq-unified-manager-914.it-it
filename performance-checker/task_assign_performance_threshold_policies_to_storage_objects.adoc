...
Tutti gli oggetti della pagina
 a| 
Nella image:../media/select_dropdown_65_png.gif["selezionare l'icona a discesa"]casella di riepilogo a discesa e scegliere *Seleziona tutti gli oggetti in questa pagina*.
...
Tutti gli oggetti dello stesso tipo
 a| 
Nella image:../media/select_dropdown_65_png.gif["selezionare l'icona a discesa"]casella a discesa e scegliere *Seleziona tutti gli oggetti*.
