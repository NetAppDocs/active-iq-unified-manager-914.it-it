...
. Fare clic sull'icona Altro image:../media/more_icon.gif[""], fare clic su *Modifica*, definire i dettagli della pianificazione del rapporto e salvare il rapporto.
+
[NOTE]
====
È inoltre possibile eliminare i referti indesiderati dall'icona Altro image:../media/more_icon.gif[""].
